...
public class ApplicationProgrammingInterface {
  ...
  static boolean isResponseSuccess(int responseCode) {
  ...
  public static String get(String url, String token) throws Exception {
    ...
    in.close();
    LOGGER.info("Respone Info: " + respone.substring(0, respone.length() - 1));
...
//		if (conn.getResponseCode() / 100 == 2) {
    if (isResponseSuccess(conn.getResponseCode())) {
