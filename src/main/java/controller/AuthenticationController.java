...
public class AuthenticationController extends BaseController {
  ...
  // clean code : sua ten bien de hieu
  // clean code: chuyen cac phuong thuc so sanh vao trong method
  /*
