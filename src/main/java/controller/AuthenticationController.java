...
public class AuthenticationController extends BaseController {
	...
	public void logout() {
		SessionInformation.getInstance().getMainUser() = null;// common coupling: dung bien toan cuc mainUser
		SessionInformation.getInstance().getExpiredTime() = null;// common coupling: dung bien toan cuc expiredTime
	}
